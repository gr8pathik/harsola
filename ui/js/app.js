...
var myApp = angular.module('myApp',
    [   'myApp.filters',
        ...
        'myApp.controllers', // custom controllers
//        'ngGrid', // angular grid
        'ui', // angular ui
...
myApp.config(['$routeProvider', '$locationProvider', '$httpProvider', function ($routeProvider, $locationProvider, $httpProvider) {
    ...
    $routeProvider.when('/about/ahmedabad', {
        templateUrl:'partials/about/ahmedabad.html'
    });
    $routeProvider.when('/about/mumbai', {
        templateUrl:'partials/about/mumbai.html'
    });
    $routeProvider.when('/about/pune', {
        templateUrl:'partials/about/pune.html'
    });

    //Members Part
    $routeProvider.when('/members/new', {
        templateUrl:'partials/members/new-member.html'
    });
